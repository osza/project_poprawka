...
require_once("./contact/include/simple-captcha.php");
...
$formproc->AddRecipient('poszenda@gmail.com'); //<<---Put your email address here


//2. For better security. Get a random tring from this link: http://tinyurl.com/randstr
// and put it here
$formproc->SetFormRandomKey('PanuebiP5q13tft');
...
if(isset($_POST['submitted']))
{
   ...
   {
        $formproc->RedirectToURL("./contact/thank-you.php");
   }
}
